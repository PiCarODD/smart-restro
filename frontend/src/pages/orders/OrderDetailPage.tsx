      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2">
          {order.status !== 'completed' && order.status !== 'cancelled' && (
            <>
              <Button variant="outline" onClick={() => navigate('pos', { tableId: order.tableId })}>
                <Plus className="mr-2 h-4 w-4" />
                Add Items
              </Button>
              {order.status === 'served' && (
                <Button onClick={() => navigate('tables.orders', { tableId: order.tableId })}>
          ...
          <CardContent>
            ...
            <div className="space-y-2">
              ...
              {(() => {
                ...
                const taxAmount = parseFloat(order.tax?.toString() || '0');
                return autoApplyTax && taxAmount > 0 ? (
